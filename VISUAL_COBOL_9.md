# <span id="top">Visual COBOL 9</span> <span style="font-size:90%;">[↩](./README.md#top)</span>
...
<img src="./docs/images/Visual_COBOL_9_Setup.png" width="80%"/>
...
<pre style="font-size:80%;">
<b>&gt; "%COBDIR%L\bin64\cblms.exe" -L</b>
Micro Focus COBOL - Configuration Utility for the Microsoft Build Tools & SDK
9.0.0.49 (C) Copyright 1984-2023 Micro Focus or one of its affiliates.
