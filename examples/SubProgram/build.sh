...
Usage: $BASENAME { <option> | <subcommand> }
  ...
  Subcommands:
    ...
    run          execute main class "$PROJECT_NAME$TARGET_EXT"
EOS
}
...
compile_cob() {
    ...
    export COB_CFLAGS="-I \"$MSYS_HOME/mingw64/include\" -I \"$COB_HOME/include\" -pipe -Wno-unused -fsigned-char -Wno-pointer-sign"
