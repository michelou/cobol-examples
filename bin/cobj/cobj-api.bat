...
@rem echo "%_JAVA_CMD%" %_JAVA_OPTS% jp.osscons.opensourcecobol.libcobj.user_util.cobj_api.ApiFiles %* 1>&2
"%_JAVA_CMD%" %_JAVA_OPTS% jp.osscons.opensourcecobol.libcobj.user_util.cobj_api.ApiFiles %*
